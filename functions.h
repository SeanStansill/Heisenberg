...
void local_M(const double theta, const double phi, double &Sx, double &Sy, double &Sz, double &S);
...
void MC_typewriter(double (&theta)[L][L][L], double (&phi)[L][L][L], const int near_n[L][2], const double T, double &E, double &E_sum, double &E_sumsquares, double &Mx, double &My, double &Mz, double &M, double &M_sum, double &M_sumsquares, double &M_sumfour, const int b, double &Sx, double &Sy, double &Sz, double &S);
