...
double new_local_energy(int i, int j, int k, double theta[L][L][L], double phi[L][L][L], int near_n[L][2], double t1[L][L][L] = {}, double t2[N][N][N] = {}){
    double e = 0.0;
    for(int o = 0; o<2; o++) {
...
double heat_cap(double theta[L][L][L], double phi[L][L][L], int near_n[L][2], double T){  //(double E, double e_squared, double T){
